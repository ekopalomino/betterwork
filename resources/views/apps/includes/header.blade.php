<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item d-none d-sm-inline-block">
   	...
   	<li class="nav-item d-none d-sm-inline-block">
     	<a href="{{route('config.index') }}" class="nav-link {{set_active(['application.index','config.index','position.index','leaveType.index','reimbursType.index','docCat.index','grievCat.index','coaCat.index','assetCat.index','user.index','logs.index']) }}">Configuration</a>
   	</li>
   	<li class="nav-item d-none d-sm-inline-block">
