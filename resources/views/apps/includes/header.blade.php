<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	<ul class="navbar-nav">
		...
		<li class="nav-item d-none d-sm-inline-block">
			...
			'bankStatement.index','account.show','asset.index','journal.index','journal.report','budget.index','budgetDetail.create','budgetDetail.edit','statToAcc.index','asset.show','coaCat.index','bankAcc.index','assetCat.index','bankStatement.import','asset.index','account.show','trial.index','findAcc.find','trial.report','ledger.index']) }}">Finance</a>
		</li>
		@endcan
		<li class="nav-item d-none d-sm-inline-block">
