	...
	<div class="row">
		<div class="col-12"> 
            ...
            <label for="inputEmail" class="col-sm-12 col-form-label">Training Provider</label>
                <div class="col-sm-12">
                    {!! Form::text('training_provider', null, array('placeholder' => 'Training Provider','class' => 'form-control')) !!}
                </div>
            <label for="inputEmail" class="col-sm-12 col-form-label">Training Title</label>
                <div class="col-sm-12">
                    {!! Form::text('training_title', null, array('placeholder' => 'Training Title','class' => 'form-control')) !!}
                </div>
            <label for="inputEmail" class="col-sm-12 col-form-label">Training Location</label>
                <div class="col-sm-12">
                    {!! Form::text('location', null, array('placeholder' => 'Training Location','class' => 'form-control')) !!}
                </div>
            <label for="inputEmail" class="col-sm-12 col-form-label">Training From Date</label>
                <div class="col-sm-12">
                    {!! Form::date('training_start', old('from'), array('id' => 'datepicker','class' => 'form-control')) !!}
                </div>
            <label for="inputEmail" class="col-sm-12 col-form-label">Training To Date</label>
                <div class="col-sm-12">
                    {!! Form::date('training_end', old('to'), array('id' => 'datepicker','class' => 'form-control')) !!}
                </div>
